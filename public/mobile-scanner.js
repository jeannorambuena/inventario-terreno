export { createLookupCodeVariants } from './code-normalization.js';
...
// La normalización de códigos vive en code-normalization.js para que la API
// manual y este lector histórico compartan exactamente las mismas reglas.
